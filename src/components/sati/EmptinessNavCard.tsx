...
import { EmptinessStats } from '../../types/SatiTypes';
...
const EmptinessNavCard: React.FC = () => {
    ...
    return (
        <div className="glass-card" onClick={() => history.push('/sati/emptiness')} style={{
            margin: '0 0 24px',
            padding: '20px',
            cursor: 'pointer'
        }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div className="icon-wrapper icon-wrapper--medium" style={{ borderColor: 'var(--color-mahayana-primary)40', background: 'var(--color-mahayana-primary)10' }}>🕉️</div>
                    <div>
                        <h2 style={{ margin: 0, fontSize: '1.2rem', fontWeight: 'bold', color: 'var(--color-text-primary)' }}>Suññatā Bhāvanā</h2>
                        <p style={{ margin: '4px 0 0', fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>Emptiness Contemplation</p>
                    </div>
                </div>
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ fontWeight: 'bold', color: 'var(--color-mahayana-primary)', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        {stats?.currentStreak || 0} days <IonIcon icon={flame} />
                    </div>
                </div>
            </div>

            <div style={{ marginTop: '16px', textAlign: 'right', fontWeight: '600', color: 'var(--color-mahayana-primary)', fontSize: '0.9rem' }}>
                Enter Practice →
            </div>
        </div>
    );
